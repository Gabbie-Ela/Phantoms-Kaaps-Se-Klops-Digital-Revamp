...
class ArtistDetailFragment : Fragment() {
    ...
    private fun bindData() {
        vm.observeUpcomingForArtist(artistId).observe(viewLifecycleOwner) { rows ->
    ...
    companion object {
        ...
        fun newInstance(artistId: Long): ArtistDetailFragment =
            ArtistDetailFragment().apply {
                arguments = Bundle().apply { putLong(ARG_ARTIST_ID, artistId) }
            }
    }
}
